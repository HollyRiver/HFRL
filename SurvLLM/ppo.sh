...
nohup python PPO.py --config config/PPO_config_v1.1.2.11H.yaml > logs/ppo_log_v1.1.2.11H.txt &
...
nohup python vllm_inference.py --base_model_path="base_model/Llama-3.1-8B-Instruct-nf4"\
                               --adapter_path="adapter/PPO-Llama-v1.1.2.11H"\
                               --inference_data="data/inference_data.json"\
                               --output_dir="inference/inference_PPO_RLHF_v1.1.2.11.csv"\
                               --sampling=True\
